                    ...
                    <div className = {'pt-5 pb-5'}>
                        <ul id = 'iconlist' className = {'d-flex m-0'}>
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'} style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href='https://www.facebook.com/realtor.com/'>
                            ...
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'}  style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href="https://twitter.com/realtordotcom">
                            ...
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'}  style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href="https://www.linkedin.com/company/realtor">
                            ...
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'}  style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href="https://www.instagram.com/realtordotcom/">
                            ...
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'}  style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href="https://www.pinterest.com/Realtors/">
                            ...
                            <li className = {'iconslist'}>
                                <a className = {'mx-2'}  style = {{backgroundColor:'white',padding:'10px 15px',borderRadius:'5px'}} target="_blank" href="https://www.youtube.com/user/RealtorDotCom">
